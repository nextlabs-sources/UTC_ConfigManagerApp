...
public class SubNetUtils {
    ...
    public final class SubnetInfo {
        ...
        private boolean isInRange(int address)      { return ((address>=low()) && (address<=high())); }
    ...
    public static void main(String[] args){
    	SubNetUtils su = new SubNetUtils("36.248.0.0/14"); // 36.251.255.255
    	//String[] addrs = su.getInfo().getAllAddresses();
    	
    	
    	System.out.println(su.getInfo().isInRange("36.248.0.1"));
    	System.out.println(su.getInfo().isInRange("36.248.1.0"));
    	System.out.println(su.getInfo().isInRange("36.249.0.1"));
    	System.out.println(su.getInfo().isInRange("36.247.0.1"));
    	System.out.println(su.getInfo().isInRange("36.251.0.1"));
    	System.out.println(su.getInfo().isInRange("36.252.0.1"));
    }
}
